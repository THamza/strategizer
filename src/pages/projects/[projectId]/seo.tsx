...
const SeoKeywordsPage: NextPage = () => {
        ...
        <div className="row ml-72 mt-20">
          ...
          {!isLoading ? (
            <div className="grid grid-cols-1 gap-4 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3">
              {seoKeywords.map((seoKeyword) => (
                <div
                  key={seoKeyword.id}
                  className="card mr-8 w-96 bg-white shadow-xl"
                >
                  <div className="card-body">
                    <h2 className="text-lg font-bold">{seoKeyword.keyword}</h2>

                    {/* Progress Bar for Pertinence */}
